...
if __name__ == '__main__':
    ...
    kalei.evaluate('foo(199, 1)')
    #kalei.evaluate('putchard(19); putchard(19)')
    #kalei.evaluate('for x=0, x<50, 1 in  putchard(x)')
    kalei.evaluate('putchard(10); putchard(13);')
    kalei.evaluate('for x=1, x<40,1 in putchard(65)')
    kalei.evaluate('putchard(10); putchard(13);')
    kalei.evaluate('foo(199, 2)')
