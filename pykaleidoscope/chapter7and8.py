...
if __name__ == '__main__':
    ...
    kalei.evaluate("extern putchar(x)") #++
...
"""
ld -e main out.o -o o1
ld -e foo out.o -o o1

ld: warning: cannot find entry symbol main; defaulting to 0000000000401000
ld: out.o: in function `putchard':
<string>:(.text+0x7): undefined reference to `putchar'

#then can't fined entry symbol main
def main(x)
           foo(x x x)
           1          
